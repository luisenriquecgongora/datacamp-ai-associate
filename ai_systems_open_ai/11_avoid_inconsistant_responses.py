...
messages.append({"role": "system", "content": "Not to assume any values for the responses. For example is the text doesn't contain a review we should not return a product name"})
...
response =  client.chat.completions.create(
        ...
        # Force the model to call extract_review_info specifically
